 ...
 */
public class APDPlatLocalContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean
		implements ResourceLoaderAware, LoadTimeWeaverAware {

	private PersistenceUnitManager persistenceUnitManager;

	private final APDPlatPersistenceUnitManager internalPersistenceUnitManager =
			new APDPlatPersistenceUnitManager();
	 ...
	 * that this APDPlatLocalContainerEntityManagerFactoryBean should parse
